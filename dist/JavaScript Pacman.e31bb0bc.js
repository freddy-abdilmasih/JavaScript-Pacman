...
var Pacman = /*#__PURE__*/function () {
  function Pacman(speed, startPos) {
    ...
    this.pos = startPos; // starting position
...
var POWER_PILL_TIME = 10000; // ms, PowerPill lasts for 10 seconds

var GLOBAL_SPEED = 80; // ms -Global speed for game loop
...
function startGame() {
  ...
  var pacman = new _Pacman.default(2, 287); // 2 = speed, 287 = position

  gameBoard.addObject(287, [_setup.OBJECT_TYPE.PACMAN]);
  document.addEventListener('keydown', function (e) {
    return pacman.handleKeyInput(e, gameBoard.objectExist);
  });
  var ghosts = [new _Ghost.default(5, 188, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.BLINKY), // speed = 5, position = 188
  new _Ghost.default(4, 209, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghost.default(3, 230, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghost.default(2, 251, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.CLYDE)];
...
//# sourceMappingURL=/JavaScript%20Pacman.e31bb0bc.js.map